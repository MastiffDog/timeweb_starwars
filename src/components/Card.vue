          ...
          <md-card-content class="content">
            <div class="md-layout md-gutter">
              <div class="md-layout-item">
                <p>Gender: <span class="card-content">{{person.gender}}</span></p>
                <p>Height: <span class="card-content">{{person.height}}</span></p>
                <p>Mass: <span class="card-content">{{person.mass}}</span></p>
              </div>
              <div class="md-layout-item">
                <p>Starships:</p>  
                  <p v-show="!exists" class="noShip"> I have no starships</p>                 
                  <div class="personShips" v-show="exists" v-for="item in starships" :key="item.id">{{item}}</div>
              </div>
            </div>
          </md-card-content>
          <hr>
          <md-card-actions>
            <md-button class="md-raised md-primary" v-on:click="getPerson()" mddisabled=personDataReady>See more person info</md-button>
          </md-card-actions>
        </md-ripple>
        <md-ripple v-show="!dataIsLoaded">
          <md-card-header>
